 ...
 * 
*/
namespace minerva_gallery\minerva\models;
...
class Page extends \minerva\models\Page {
	...
	protected $_schema = array(
		...
		'tags' => array(
			'type' => 'array',
			'form' => array(
				'help_text' => 'Add some tags to this gallery to easily find it later.',
				'position' => 'options',
				'class' => 'tagger'
			)
		),
		'gallery_item_order' => array('type' => 'array')
	);
	...
	public $validates = array(
		'title' => array(
		    array('notEmpty', 'message' => 'You must provide a title.')
		)
	);
	
	// A little context
	public $display_name = 'Gallery';
	...
	//public $document_type = 'gallery';
	
	// You could actually also change the _meta! so you can store this in another collection, unlock the shcema, etc.
	// No compromise on Lithium functionality. Not sure one would ever want to do this...but...you can.
	/* 
